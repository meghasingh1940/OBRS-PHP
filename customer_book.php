...
<div class="container-fluid">
    ...
    <select class="form-control" id="gender" name="gender">
        <option value="male" <?php echo (isset($bmeta['gender']) && $bmeta['gender'] === 'Male') ? 'selected' : '' ?>>Male</option>
        <option value="female" <?php echo (isset($bmeta['gender']) && $bmeta['gender'] === 'Female') ? 'selected' : '' ?>>Female</option>
    </select>
</div>
